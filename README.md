...
- `AP_Analysis.ipynb`: the complete, executed analysis notebook. Reprocesses raw data when present, otherwise loads cached per-day outputs, and reproduces every table and figure in the report.
